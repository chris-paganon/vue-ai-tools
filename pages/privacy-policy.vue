  ...
  <main class="flex-grow-1 flex justify-content-center py-5 px-3">
    <section>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to VueAI.tools.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to VueAI.tools, accessible from
            <a
              href="https://vueai.tools"
      ...
      <p>
        ...
        to, the type of mobile device You use, Your mobile operating system, the
      ...
      <p>
        ...
        are cookies and scripts to collect and track information and to improve
      ...
      <p>
        ...
        by email at info@chrispaganon.com
      </p>
    </section>
  </main>
</template>
