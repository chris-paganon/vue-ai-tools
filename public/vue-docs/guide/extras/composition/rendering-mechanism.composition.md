...
The virtual DOM (VDOM) is a programming concept where an ideal, or â€œvirtualâ€, representation of a UI is kept in memory and synced with the â€œrealâ€ DOM. The concept was pioneered by [React](https://reactjs.org/), and has been adopted in many other frameworks with different implementations, including Vue.
