...
export async function useHandleChatDb(message: OpenAI.Chat.Completions.ChatCompletionMessageParam, currentChatId: number, currentChatName: string) {
...
export async function useMaybeAddChatToDb(currentChatId: number, currentChatName: string) {
...
export async function useAddMessageToDb(message: OpenAI.Chat.Completions.ChatCompletionMessageParam, chatId: number) {
