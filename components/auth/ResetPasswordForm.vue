<template>
	<form @submit="modifyPassword" class="flex flex-column gap-2">
		...
		<Button label="Send password reset email" class="mt-4" @click="modifyPassword" :loading="isRequestPasswordResetLoading" />
		<Button label="Cancel" outlined class="mt-2" @click="$emit('cancelPassordReset')" />
